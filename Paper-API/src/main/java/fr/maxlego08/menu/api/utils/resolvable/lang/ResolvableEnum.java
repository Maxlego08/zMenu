...
public final class ResolvableEnum<E extends Enum<E>> extends ParsableResolvable<E> {
    private final @NotNull Class<E> enumClass;

    private ResolvableEnum(@NotNull Class<E> enumClass, @Nullable E resolvedValue, @Nullable String expression) {
    ...
    public static <E extends Enum<E>> ResolvableEnum<E> autoOrNull(@NotNull Class<E> enumClass, @Nullable String toResolve) {
        if (toResolve == null || toResolve.isBlank()) return null;
