...
import fr.maxlego08.menu.requirement.actions.ItemEditAction;

import java.io.File;
import java.util.Map;

public class ItemEditLoader extends ActionLoader {
    private final MenuPlugin menuPlugin;

    public ItemEditLoader(MenuPlugin menuPlugin) {
        super("item_edit", "item-edit");
