...
import fr.maxlego08.menu.itemstack.components.RepairCostComponent;
...
public class SpigotRepairCostItemComponentLoader extends ItemComponentLoader {

    public SpigotRepairCostItemComponentLoader(){
        super("repair_cost");
    }
