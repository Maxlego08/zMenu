...
public class ZEnchantments implements Enchantments {
    ...
    public Optional<MenuEnchantment> getEnchantments(String enchantment) {
        return essentialsEnchantments.stream().filter(menuEnchantment -> menuEnchantment.getAliases().contains(enchantment.toLowerCase())).findFirst();
    }
    ...
    public void register() {
        ...
        this.register(Enchantment.getByName("DEPTH_STRIDER"), "depthstrider", "depth", "strider");
        this.register(Enchantment.getByName("FROST_WALKER"), "frostwalker", "frost", "walker");
        this.register(Enchantment.getByName("MENDING"), "mending");
        this.register(Enchantment.getByName("BINDING_CURSE"), "bindingcurse", "bindcurse", "binding", "bind");
        this.register(Enchantment.getByName("VANISHING_CURSE"), "vanishingcurse", "vanishcurse", "vanishing", "vanish");
        this.register(Enchantment.getByName("SWEEPING_EDGE"), "sweepingedge", "sweepedge", "sweeping");
        ...
        this.register(Enchantment.getByName("QUICK_CHARGE"), "quickcharge", "quickdraw", "fastcharge", "fastdraw");
        this.register(Enchantment.getByName("PIERCING"), "piercing");
        this.register(Enchantment.getByName("SOUL_SPEED"), "soulspeed", "soilspeed", "sandspeed");
        this.register(Enchantment.getByName("SWIFT_SNEAK"), "swiftsneak");
