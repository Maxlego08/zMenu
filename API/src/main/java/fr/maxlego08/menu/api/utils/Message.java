...
public enum Message implements IMessage {
    ...
    WEBSITE_SYNC_ALREADY_LINKED("&cThis server is already linked. Use &f/zmenu connect&c."),
    WEBSITE_SYNC_NOT_LINKED("&cThis server is not linked yet. Run &f/zmenu login&c first."),
    ...
    WEBSITE_SYNC_AUTH_FAILED("&cThe live channel could not be authenticated. Try re-linking with &f/zmenu login&c."),
    WEBSITE_SYNC_DISCONNECTED("&cLive sync disconnected."),
    WEBSITE_SYNC_UNLINKED("&aThis server was unlinked from the website. Run &f/zmenu login&a to link again."),
