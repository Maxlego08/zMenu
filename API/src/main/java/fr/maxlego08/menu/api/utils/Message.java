...
public enum Message implements IMessage {
    ...
    DESCRIPTION_UNLINK("Unlink this server from the website (revoke the live-sync token)"),
    ...
    DESCRIPTION_BEDROCK_RELOAD("Allows you to reload bedrock inventory files configuration"),
