...
public final class WolfVariantComponent extends ItemComponent {
    private final ResolvableRegistryEntry<Wolf.Variant> variant;

    public WolfVariantComponent(ResolvableRegistryEntry<Wolf.Variant> variant) {
