...
public class DialogBooleanInputBuilder implements DialogInputBuilderInt {
    private final ZDialogManager dialogManager;
    private final MenuPlugin menuPlugin;

    public DialogBooleanInputBuilder(ZDialogManager dialogManager, MenuPlugin menuPlugin) {
