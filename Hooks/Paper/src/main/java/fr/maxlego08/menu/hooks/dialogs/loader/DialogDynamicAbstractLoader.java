...
public abstract class DialogDynamicAbstractLoader extends ButtonLoader {

    protected final MenuPlugin plugin;

    public DialogDynamicAbstractLoader(@NotNull MenuPlugin plugin, @NotNull String name) {
        super(plugin, name);
        this.plugin = plugin;
    }
